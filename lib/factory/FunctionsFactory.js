...
var FunctionsFactory = function(){
    ...
    this.listFunctionManagerByFileMain = {};
    ...
    this.addFunctionManager = function(functionManager){
        if (functionManager){
            ...
            this.listFunctionManagerByFileMain[functionManager.fileMain] = functionManager;
        ...
        if (itemManager){
            ...
            if (itemStage){
                ...
                if (functionManager){
                    ...
                    delete this.listFunctionManagerByFileMain[functionManager.fileMain];
    ...
    this.removeFunctionManagerFromFileName = function(file){
        ...
        item = this.listFunctionManagerByFile[file];
        if (item === undefined){
            item = this.listFunctionManagerByFileMain[file];
        }
        if (item){
