...
var functionTest = require("./functionsTest");
...
var FunctionsFactory = function(){
    ...
    this.extension.fileModules = new FileExtension(this);
        ...
        if (itemManager){
            ...
            if (itemStage){
                ...
                if (functionManager){
                    ...
                    itemStage._lastVersion = null;
                    var keys = Object.keys(factory.listFunctionManagerByFile);
    ...
    this.buildFunctionManager = function(moduleInstance, opt){
        ...
        if (functionManager.module.test){
            ...
            functionManager.module.exports = functionTest;
        }
        else{
            //exports
