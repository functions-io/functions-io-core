...
var InvokeFactory = function(p_moduleFactory){
    ...
    this.filter = function(moduleObj, data, context, callBack){
        callBack(null);
    };
    ...
    this.invokeAsync = function(moduleName, moduleVersion, data, context){
        return new Promise(function(resolve, reject){
            try {
                ...
                self.preFilter(moduleName, moduleVersion, data, context, function(errPreValidate){
                    try {
                        if (errPreValidate){
                            ...
                            self.moduleFactory.requireAsync(moduleName, moduleVersion).then(function(moduleObj){
                                try {
                                    if (moduleObj instanceof Function){
                                        self.filter(moduleObj, data, context, function(errValidate){
                                            try {
                                                if (errValidate){
                                                    reject(errValidate);
                                                }
